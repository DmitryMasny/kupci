...
function custom_product() {
	...
	register_post_type( 'product', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			'name' => 'Продукты', /* This is the Title of the Group */
			'singular_name' => 'Продукт', /* This is the individual type */
			'all_items' => 'Все продукты', /* the all items menu item */
			'add_new' => 'Создать новый', /* The add new menu item */
			'add_new_item' => 'Создать новый продукт', /* Add New Display Title */
			...
			'description' => 'Пример продукта', /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/fruit.png', /* the icon for the custom post type menu */
	...
	*/
	...
	register_taxonomy( 'product_cat',
		...
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				'name' => 'Категории продуктов', /* name of the custom taxonomy */
